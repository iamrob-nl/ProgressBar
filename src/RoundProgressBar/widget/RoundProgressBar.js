...
define([
  ...
  "dojo/text!RoundProgressBar/widget/template/RoundProgressBar.html",
  ...
  return declare("RoundProgressBar.widget.RoundProgressBar", [ _WidgetBase, _TemplatedMixin ], {
    ...
    _drawSVG: function() {
      ...
      var secondLine = this._contextObj ? this._contextObj.get(this.secondLineAttr) : "";
...
require(["RoundProgressBar/widget/RoundProgressBar"], function() {
  "use strict";
});
