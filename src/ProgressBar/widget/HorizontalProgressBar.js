...
define([
  ...
  "dojo/text!ProgressBar/widget/template/HorizontalProgressBar.html",
  ...
  return declare("ProgressBar.widget.HorizontalProgressBar", [ _WidgetBase, _TemplatedMixin ], {
...
require(["ProgressBar/widget/HorizontalProgressBar"], function() {
  "use strict";
});
